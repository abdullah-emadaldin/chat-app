        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserChatChatId = table.Column<string>(type: "nvarchar(255)", nullable: true),
                    UserChatUserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Messages_UserChat_UserChatChatId_UserChatUserId",
                        columns: x => new { x.UserChatChatId, x.UserChatUserId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_UserChatChatId_UserChatUserId",
                table: "Messages",
                columns: new[] { "UserChatChatId", "UserChatUserId" });
